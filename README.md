...
## Инструкция по просмотру сформированного отчета Allure на примере "Калькулятор"
...
2. В отчете Allure вы увидите:
   ...
   - **Описание теста**: Тестирование калькулятора, проверка корректной работы приложения.
   - **Шаги теста**:
     - Открытие формы.
